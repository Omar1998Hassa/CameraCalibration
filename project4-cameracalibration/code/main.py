...
from student import (calculate_projection_matrix, compute_camera_center,
                     ...
                     apply_positional_noise, apply_matching_noise,Normalized_estimate_fundamental_matrix)
...
def main(args):
    ...
    #print(os.path.dirname(os.path.dirname(__file__)) + '/data/')
    ...
    if args.no_ransac:
        ...
        [F_matrix2, matched_points_a,
         matched_points_b] = ransac_fundamental_matrix(Points_2D_pic_a,
                                                       Points_2D_pic_b)
        draw_epipolar_lines(F_matrix2, pic_a, pic_b, Points_2D_pic_a,
                            Points_2D_pic_b)
